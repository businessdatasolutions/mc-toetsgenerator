...
SYSTEM_PROMPT_REPAIR = (
    ...
    "- Lege antwoordopties aanvullen met plausibele afleiders.\n"
    "- Het correcte antwoord bepalen als dat ontbreekt.\n"
...
def build_repair_prompt(
    ...
    user_content = (
        ...
        "- option_a, option_b, option_c, option_d: Als een optietekst leeg is, "
        "genereer een plausibele afleider. Gebruik field='option_a' t/m 'option_d'.\n"
        "- correct_option: Als er geen correct antwoord is aangeduid, bepaal welke "
        "optie correct is. Gebruik field='correct_option' met waarde 'A', 'B', 'C' of 'D'.\n"
